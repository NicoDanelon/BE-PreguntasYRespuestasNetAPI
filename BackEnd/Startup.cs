...
namespace BackEnd
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string mySqlConnection = Configuration.GetConnectionString("DefaultConection");
            ...
            services.AddScoped<IRespuestaCuestionarioRepository, RespuestaCuesitonarioRepository>();
